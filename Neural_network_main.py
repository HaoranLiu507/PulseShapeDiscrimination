...
def main() -> None:
    ...
    parser = argparse.ArgumentParser(description="Neural Network (spiking) PSD entry point (interactive by default; CLI flags optional)")
    parser.add_argument("--method", type=str, help="Method (HQC, LG, PCNN, RCNN, SCM)")
